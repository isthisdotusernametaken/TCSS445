...
-- Shipments
INSERT INTO SHIPMENT (ShipmentID, DistributorID, PurchaseDate, ReceiveDate)
...
-- Discounts
INSERT INTO DISCOUNT (DiscountID, DiscountName, Percentage, Reusability, InitialValidDate, ExpirationDate)
...
-- Transactions
INSERT INTO TRANSACTION (TransactionID, CustomerID, PurchaseDate, TaxAmount, DiscountID)
...
-- Chemical Types
INSERT INTO CHEMICAL_TYPE (ChemicalTypeID, ChemicalName, MeasurementUnitName, StateOfMatterName)
...
-- Chemicals
INSERT INTO CHEMICAL (ChemicalID, ChemicalTypeID, Purity, InitialQuantity, RemainingQuantity, ShipmentID, TotalPurchasePrice)
...
-- Reviews
INSERT INTO REVIEW (ReviewID, TransactionID, ChemicalID, Stars, Text, ReviewDate)
